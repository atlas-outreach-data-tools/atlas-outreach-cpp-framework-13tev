...
void main_ZZDiBosonAnalysis(int proof)
{
  ...
  chain_Wenu_PTVnuJetsBVeto->Process("ZZDiBosonAnalysis.C+","Wenu_PTVnuJetsBVeto");
  ...
  chain_Wenu_PTVnuNoJetsBVeto->Process("ZZDiBosonAnalysis.C+","Wenu_PTVnuNoJetsBVeto");

  TChain* chain_Wmunu_PTVnuWithB = new TChain("mini");
  chain_Wmunu_PTVnuWithB->AddFile(path+"MC/mc_167743.Wmunu_PTVnuWithB.root");
  chain_Wmunu_PTVnuWithB->Process("ZZDiBosonAnalysis.C+","Wmunu_PTVnuWithB");
  ...
  chain_Wmunu_PTVnuJetsBVeto->Process("ZZDiBosonAnalysis.C+","Wmunu_PTVnuJetsBVeto");
  ...
  chain_Wmunu_PTVnuNoJetsBVeto->Process("ZZDiBosonAnalysis.C+","Wmunu_PTVnuNoJetsBVeto");

  TChain* chain_Wtaunu_PTVnuWithB = new TChain("mini");
  chain_Wtaunu_PTVnuWithB->AddFile(path+"MC/mc_167746.Wtaunu_PTVnuWithB.root");
  chain_Wtaunu_PTVnuWithB->Process("ZZDiBosonAnalysis.C+","Wtaunu_PTVnuWithB");
  ...
  chain_Wtaunu_PTVnuJetsBVeto->Process("ZZDiBosonAnalysis.C+","Wtaunu_PTVnuJetsBVeto");
