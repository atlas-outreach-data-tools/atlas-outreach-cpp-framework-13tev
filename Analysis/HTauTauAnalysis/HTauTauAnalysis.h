//////////////////////////////////////////////////////////
#ifndef HTauTauAnalysis_h
#define HTauTauAnalysis_h
...
class HTauTauAnalysis : public TSelector {
public :
  ...
  ROOT::VecOps::RVec<bool> *lep_isMediumID;
  ROOT::VecOps::RVec<bool> *lep_isLooseIso;
  ...
  TBranch *b_lep_isMediumID;
  TBranch *b_lep_isLooseIso;
  ...
  HTauTauAnalysis(TTree * =0) : fChain(0) { }
  virtual ~HTauTauAnalysis() { }
  ...
  ClassDef(HTauTauAnalysis,0);
};

#endif

#ifdef HTauTauAnalysis_cxx
void HTauTauAnalysis::Init(TTree *tree)
{
  ...
  fChain->SetBranchAddress("lep_isMediumID", &lep_isMediumID, &b_lep_isMediumID);
  fChain->SetBranchAddress("lep_isLooseIso", &lep_isLooseIso, &b_lep_isLooseIso);
...
#endif // #ifdef HTauTauAnalysis_cxx
