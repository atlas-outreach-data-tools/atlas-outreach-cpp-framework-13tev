...
void main_TTbarDilepAnalysis(int proof = 0, int option= 0)
{
  ...
  if (option==1 || option==0){
    ...
    chain_data->AddFile(path+"Data/data15_periodD."+skim+".root");
    chain_data->AddFile(path+"Data/data15_periodE."+skim+".root");
    chain_data->AddFile(path+"Data/data15_periodF."+skim+".root");
    chain_data->AddFile(path+"Data/data15_periodG."+skim+".root");
    chain_data->AddFile(path+"Data/data15_periodH."+skim+".root");
    chain_data->AddFile(path+"Data/data15_periodJ."+skim+".root");
    
    //data16
    chain_data->AddFile(path+"Data/data16_periodA."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodB."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodC."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodD."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodE."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodF."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodG."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodI."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodK."+skim+".root");
    chain_data->AddFile(path+"Data/data16_periodL."+skim+".root");
  ...
  if (option==2 || option==0){
    ...
    chain_ttbar_nonallhad->AddFile(path+"MC/mc_410470.PhPy8EG_A14_ttbar_hdamp258p75_nonallhad."+skim+".root");
    ...
    chain_ttbar_allhad->AddFile(path+"MC/mc_410471.PhPy8EG_A14_ttbar_hdamp258p75_allhad."+skim+".root");
  ...
  if (option==3 || option==0){
    ...
    chain_tchan_BW50_lept_top->AddFile(path+"MC/mc_410658.PhPy8EG_A14_tchan_BW50_lept_top."+skim+".root");
    ...
    chain_tchan_BW50_lept_antitop->AddFile(path+"MC/mc_410659.PhPy8EG_A14_tchan_BW50_lept_antitop."+skim+".root");
    ...
    chain_schan_lept_top->AddFile(path+"MC/mc_410644.PowhegPythia8EvtGen_A14_singletop_schan_lept_top."+skim+".root");
    ...
    chain_schan_lept_antitop->AddFile(path+"MC/mc_410645.PowhegPythia8EvtGen_A14_singletop_schan_lept_antitop."+skim+".root");
    ...
    chain_tW_dyn_DR_incl_antitop->AddFile(path+"MC/mc_601352.PhPy8EG_tW_dyn_DR_incl_antitop."+skim+".root");
    ...
    chain_tW_dyn_DR_incl_top->AddFile(path+"MC/mc_601355.PhPy8EG_tW_dyn_DR_incl_top."+skim+".root");
  ...
  if (option==5 || option==0){
    ...
    chain_Zee_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700320.Sh_2211_Zee_maxHTpTV2_BFilter."+skim+".root");
    ...
    chain_Zee_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700322.Sh_2211_Zee_maxHTpTV2_CVetoBVeto."+skim+".root");
    ...
    chain_Zmumu_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700323.Sh_2211_Zmumu_maxHTpTV2_BFilter."+skim+".root");
    ...
    chain_Zmumu_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700324.Sh_2211_Zmumu_maxHTpTV2_CFilterBVeto."+skim+".root");
    ...
    chain_Zmumu_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700325.Sh_2211_Zmumu_maxHTpTV2_CVetoBVeto."+skim+".root");
    ...
    chain_Wenu_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700338.Sh_2211_Wenu_maxHTpTV2_BFilter."+skim+".root");
    ...
    chain_Wenu_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700339.Sh_2211_Wenu_maxHTpTV2_CFilterBVeto."+skim+".root");
    ...
    chain_Wenu_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700340.Sh_2211_Wenu_maxHTpTV2_CVetoBVeto."+skim+".root");
    ...
    chain_Wmunu_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700341.Sh_2211_Wmunu_maxHTpTV2_BFilter."+skim+".root");
    ...
    chain_Wmunu_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700342.Sh_2211_Wmunu_maxHTpTV2_CFilterBVeto."+skim+".root");
    ...
    chain_Wmunu_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700343.Sh_2211_Wmunu_maxHTpTV2_CVetoBVeto."+skim+".root");
    ...
    chain_Wtaunu_L_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700344.Sh_2211_Wtaunu_L_maxHTpTV2_BFilter."+skim+".root");
    ...
    chain_Wtaunu_L_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700345.Sh_2211_Wtaunu_L_maxHTpTV2_CFilterBVeto."+skim+".root");
    ...
    chain_Wtaunu_L_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700346.Sh_2211_Wtaunu_L_maxHTpTV2_CVetoBVeto."+skim+".root");
    ...
    chain_Wtaunu_H_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700347.Sh_2211_Wtaunu_H_maxHTpTV2_BFilter."+skim+".root");
    ...
    chain_Wtaunu_H_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700348.Sh_2211_Wtaunu_H_maxHTpTV2_CFilterBVeto."+skim+".root");
    ...
    chain_Wtaunu_H_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700349.Sh_2211_Wtaunu_H_maxHTpTV2_CVetoBVeto."+skim+".root");
    ...
    chain_Ztautau_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700792.Sh_2214_Ztautau_maxHTpTV2_BFilter."+skim+".root");
    ...
    chain_Ztautau_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700793.Sh_2214_Ztautau_maxHTpTV2_CFilterBVeto."+skim+".root");
    ...
    chain_Ztautau_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700794.Sh_2214_Ztautau_maxHTpTV2_CVetoBVeto."+skim+".root");
  ...
  if (option==6 || option==0){
    ...
    chain_ttW->AddFile(path+"MC/mc_410155.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttW."+skim+".root");
    ...
    chain_ttZnunu->AddFile(path+"MC/mc_410156.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttZnunu."+skim+".root");
    ...
    chain_ttZqq->AddFile(path+"MC/mc_410157.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttZqq."+skim+".root");
    ...
    chain_ttee->AddFile(path+"MC/mc_410218.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttee."+skim+".root");
    ...
    chain_ttmumu->AddFile(path+"MC/mc_410219.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttmumu."+skim+".root");
    ...
    chain_tttautau->AddFile(path+"MC/mc_410220.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_tttautau."+skim+".root");
