...
void main_TTbarDilepAnalysis(int proof = 0, int option= 0)
{
  ...
  if (option==11 || option==0){
    ...
    */
    ...
    TChain* chain_data15_D = new TChain("analysis");
    chain_data15_D->AddFile(path+"Data/data15_periodD.root");
    //if (proof == 1)  chain_data15->SetProof();
    chain_data15_D->Process("TTbarDilepAnalysis.C+","data15_D");
 
    TChain* chain_data15_E = new TChain("analysis");
    chain_data15_E->AddFile(path+"Data/data15_periodE.root");
    //if (proof == 1)  chain_data15->SetProof();
    chain_data15_E->Process("TTbarDilepAnalysis.C+","data15_E");

    TChain* chain_data15_F = new TChain("analysis");
    chain_data15_F->AddFile(path+"Data/data15_periodF.root");
    //if (proof == 1)  chain_data15->SetProof();
    chain_data15_F->Process("TTbarDilepAnalysis.C+","data15_F");
 
    TChain* chain_data15_G = new TChain("analysis");
    chain_data15_G->AddFile(path+"Data/data15_periodG.root");
    //if (proof == 1)  chain_data15->SetProof();
    chain_data15_G->Process("TTbarDilepAnalysis.C+","data15_G");

    TChain* chain_data15_H = new TChain("analysis");
    chain_data15_H->AddFile(path+"Data/data15_periodH.root");
    //if (proof == 1)  chain_data15->SetProof();
    chain_data15_H->Process("TTbarDilepAnalysis.C+","data15_H");
 
    TChain* chain_data15_J = new TChain("analysis");
    chain_data15_J->AddFile(path+"Data/data15_periodJ.root");
    //if (proof == 1)  chain_data15->SetProof();
    chain_data15_J->Process("TTbarDilepAnalysis.C+","data15_J");
  ...
  if (option==12 || option==0){
    ...
    */
    ...
    TChain* chain_data16_A = new TChain("analysis");
    chain_data16_A->AddFile(path+"Data/data16_periodA.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_A->Process("TTbarDilepAnalysis.C+","data16_A");
 
    TChain* chain_data16_B = new TChain("analysis");
    chain_data16_B->AddFile(path+"Data/data16_periodB.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_B->Process("TTbarDilepAnalysis.C+","data16_B");

    TChain* chain_data16_C = new TChain("analysis");
    chain_data16_C->AddFile(path+"Data/data16_periodC.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_C->Process("TTbarDilepAnalysis.C+","data16_C");
 
    TChain* chain_data16_D = new TChain("analysis");
    chain_data16_D->AddFile(path+"Data/data16_periodD.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_D->Process("TTbarDilepAnalysis.C+","data16_D");

    TChain* chain_data16_E = new TChain("analysis");
    chain_data16_E->AddFile(path+"Data/data16_periodE.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_E->Process("TTbarDilepAnalysis.C+","data16_E");
 
    TChain* chain_data16_F = new TChain("analysis");
    chain_data16_F->AddFile(path+"Data/data16_periodF.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_F->Process("TTbarDilepAnalysis.C+","data16_F");

    TChain* chain_data16_G = new TChain("analysis");
    chain_data16_G->AddFile(path+"Data/data16_periodG.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_G->Process("TTbarDilepAnalysis.C+","data16_G");
 
    TChain* chain_data16_I = new TChain("analysis");
    chain_data16_I->AddFile(path+"Data/data16_PeriodI.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_I->Process("TTbarDilepAnalysis.C+","data16_I");

    TChain* chain_data16_K = new TChain("analysis");
    chain_data16_K->AddFile(path+"Data/data16_periodK.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_K->Process("TTbarDilepAnalysis.C+","data16_K");
 
    TChain* chain_data16_L = new TChain("analysis");
    chain_data16_L->AddFile(path+"Data/data16_periodL.root");
    //if (proof == 1)  chain_data16->SetProof();
    chain_data16_L->Process("TTbarDilepAnalysis.C+","data16_L");
  ...
  if (option==2 || option==0){
    ...
    chain_ttbar_nonallhad->AddFile(path+"MC/mc_410470.PhPy8EG_A14_ttbar_hdamp258p75_nonallhad.2J2LMET30.root");
    ...
    chain_ttbar_dil->AddFile(path+"MC/");
  ...
  if (option==3 || option==0){
    ...
    chain_Wt_DR_dilepton_top->AddFile(path+"MC/");
    ...
    */
    ...
    chain_tchan_BW50_lept_top->AddFile(path+"MC/mc_410658.PhPy8EG_A14_tchan_BW50_lept_top.2J2LMET30.root");
    ...
    chain_tchan_BW50_lept_antitop->AddFile(path+"MC/mc_410659.PhPy8EG_A14_tchan_BW50_lept_antitop.2J2LMET30.root");
  ...
  if (option==4 || option==0){
    ...
    chain_llll->AddFile(path+"MC/mc_700600.Sh_2212_llll.2J2LMET30.root");
    ...
    chain_lllv->AddFile(path+"MC/mc_700601.Sh_2212_lllv.2J2LMET30.root");
    ...
    chain_llvv_os->AddFile(path+"MC/mc_700602.Sh_2212_llvv_os.2J2LMET30.root");
    ...
    chain_llvv_ss->AddFile(path+"MC/mc_700603.Sh_2212_llvv_ss.2J2LMET30.root");
    ...
    chain_lvvv->AddFile(path+"MC/mc_700604.Sh_2212_lvvv.2J2LMET30.root");
    ...
    chain_vvvv->AddFile(path+"MC/mc_700605.Sh_2212_vvvv.2J2LMET30.root");
    ...
    chain_WlvWqq->AddFile(path+"MC/mc_700488.Sh_2211_WlvWqq.2J2LMET30.root");
    ...
    chain_WlvZqq->AddFile(path+"MC/mc_700489.Sh_2211_WlvZqq.2J2LMET30.root");
    ...
    chain_WlvZbb->AddFile(path+"MC/mc_700490.Sh_2211_WlvZbb.2J2LMET30.root");
    ...
    chain_ZqqZll->AddFile(path+"MC/mc_700493.Sh_2211_ZqqZll.2J2LMET30.root");
    ...
    chain_ZbbZll->AddFile(path+"MC/mc_700494.Sh_2211_ZbbZll.2J2LMET30.root");
    ...
    chain_ZqqZvv->AddFile(path+"MC/mc_700495.Sh_2211_ZqqZvv.2J2LMET30.root");
    ...
    chain_ZbbZvv->AddFile(path+"MC/mc_700496.Sh_2211_ZbbZvv.2J2LMET30.root");
  ...
  if (option==5 || option==0){
    ...
    chain_Zee_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700320.Sh_2211_Zee_maxHTpTV2_BFilter.2J2LMET30.root");
    ...
    */
    ...
    chain_Zee_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700322.Sh_2211_Zee_maxHTpTV2_CVetoBVeto.2J2LMET30.root");
    ...
    chain_Zmumu_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700323.Sh_2211_Zmumu_maxHTpTV2_BFilter.2J2LMET30.root");
    ...
    chain_Zmumu_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700324.Sh_2211_Zmumu_maxHTpTV2_CFilterBVeto.2J2LMET30.root");
    ...
    chain_Zmumu_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700325.Sh_2211_Zmumu_maxHTpTV2_CVetoBVeto.2J2LMET30.root");
    ...
    chain_Wenu_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700338.Sh_2211_Wenu_maxHTpTV2_BFilter.2J2LMET30.root");
    ...
    chain_Wenu_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700339.Sh_2211_Wenu_maxHTpTV2_CFilterBVeto.2J2LMET30.root");
    ...
    chain_Wenu_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700340.Sh_2211_Wenu_maxHTpTV2_CVetoBVeto.2J2LMET30.root");
    ...
    chain_Wmunu_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700341.Sh_2211_Wmunu_maxHTpTV2_BFilter.2J2LMET30.root");
    ...
    chain_Wmunu_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700342.Sh_2211_Wmunu_maxHTpTV2_CFilterBVeto.2J2LMET30.root");
    ...
    chain_Wmunu_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700343.Sh_2211_Wmunu_maxHTpTV2_CVetoBVeto.2J2LMET30.root");
    ...
    chain_Wtaunu_L_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700344.Sh_2211_Wtaunu_L_maxHTpTV2_BFilter.2J2LMET30.root");
    ...
    chain_Wtaunu_L_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700345.Sh_2211_Wtaunu_L_maxHTpTV2_CFilterBVeto.2J2LMET30.root");
    ...
    chain_Wtaunu_L_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700346.Sh_2211_Wtaunu_L_maxHTpTV2_CVetoBVeto.2J2LMET30.root");
    ...
    chain_Wtaunu_H_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700347.Sh_2211_Wtaunu_H_maxHTpTV2_BFilter.2J2LMET30.root");
    ...
    chain_Wtaunu_H_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700348.Sh_2211_Wtaunu_H_maxHTpTV2_CFilterBVeto.2J2LMET30.root");
    ...
    chain_Wtaunu_H_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700349.Sh_2211_Wtaunu_H_maxHTpTV2_CVetoBVeto.2J2LMET30.root");
    ...
    chain_Ztautau_maxHTpTV2_BFilter->AddFile(path+"MC/mc_700792.Sh_2214_Ztautau_maxHTpTV2_BFilter.2J2LMET30.root");
    ...
    chain_Ztautau_maxHTpTV2_CFilterBVeto->AddFile(path+"MC/mc_700793.Sh_2214_Ztautau_maxHTpTV2_CFilterBVeto.2J2LMET30.root");
    ...
    chain_Ztautau_maxHTpTV2_CVetoBVeto->AddFile(path+"MC/mc_700794.Sh_2214_Ztautau_maxHTpTV2_CVetoBVeto.2J2LMET30.root");
  ...
  if (option==6 || option==0){
    ...
    chain_ttW->AddFile(path+"MC/mc_410155.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttW.2J2LMET30.root");
    ...
    chain_ttZnunu->AddFile(path+"MC/mc_410156.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttZnunu.2J2LMET30.root");
    ...
    chain_ttZqq->AddFile(path+"MC/mc_410157.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttZqq.2J2LMET30.root");
    ...
    chain_ttee->AddFile(path+"MC/mc_410218.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttee.2J2LMET30.root");
    ...
    chain_ttmumu->AddFile(path+"MC/mc_410219.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttmumu.2J2LMET30.root");
    ...
    chain_tttautau->AddFile(path+"MC/mc_410220.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_tttautau.2J2LMET30.root");
