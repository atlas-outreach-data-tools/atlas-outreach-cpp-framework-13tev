...
void main_TTbarDilepAnalysis(int proof = 0, int option= 0)
{
  ...
  if (option==4 || option==0){
    ...
    chain_WqqZvv->AddFile(path+"mc_700491.Sh_2211_WqqZvv."+skim+".root");
    chain_WqqZvv->Process("TTbarDilepAnalysis.C+","Sh_2211_WqqZvv");

    TChain* chain_WqqZll = new TChain("analysis");
    chain_WqqZll->AddFile(path+"mc_700492.Sh_2211_WqqZll."+skim+".root");
  ...
  if (option==6 || option==0){
    ...
    chain_ttW->AddFile(path+"mc_410155.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttW."+skim+".root");
    ...
    chain_ttZnunu->AddFile(path+"mc_410156.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttZnunu."+skim+".root");
    ...
    chain_ttZqq->AddFile(path+"mc_410157.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttZqq."+skim+".root");
    ...
    chain_ttee->AddFile(path+"mc_410218.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttee."+skim+".root");
    ...
    chain_ttmumu->AddFile(path+"mc_410219.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttmumu."+skim+".root");
    ...
    chain_tttautau->AddFile(path+"mc_410220.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_tttautau."+skim+".root");
