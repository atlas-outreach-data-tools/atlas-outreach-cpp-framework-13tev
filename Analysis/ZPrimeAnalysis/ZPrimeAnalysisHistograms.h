...
void ZPrimeAnalysis::define_histograms()
{
  ...
  hist_ht           = new TH1F("hist_ht",          "Sum of Jet Transverse Momentum; H_{T}^{jet} [GeV];Jets", 30, 0, 1000);
  ...
  hist_leadjet_m        = new TH1F("hist_leadjet_m",       "Leading Jet Mass; m^{leadjet} [MeV]; Jets", 20, 0, 20);
