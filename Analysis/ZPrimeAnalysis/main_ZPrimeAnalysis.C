...
void main_ZPrimeAnalysis(int proof)
{
  ...
  TChain* chain_ZPrimeAnalysis1000 = new TChain("mini");
  chain_ZPrimeAnalysis1000->AddFile(path+"MC/mc_110903.ZPrime1000.root");
  chain_ZPrimeAnalysis1000->Process("ZPrimeAnalysis.C+","ZPrime1000");
