...
void main_HWWAnalysis(int proof = 0, int option= 0)
{
  ...
  if (option==6 || option==0){
   ...
   chain_ggH125_WW->AddFile(path+"MC/mc_345324.PowhegPythia8EvtGen_NNLOPS_NN30_ggH125_WWlvlv_EF_15_5.2J2LMET30.root");
   ...
   chain_VBFH125_WW->AddFile(path+"MC/mc_345948.PowhegPy8EG_NNPDF30_AZNLOCTEQ6L1_VBFH125_WWlvlv.2J2LMET30.root");
