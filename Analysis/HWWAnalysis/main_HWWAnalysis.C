...
void main_HWWAnalysis(int proof)
{
  ...
  chain_Wenu_PTVnuJetsBVeto->Process("HWWAnalysis.C+","Wenu_PTVnuJetsBVeto");
  ...
  chain_Wenu_PTVnuNoJetsBVeto->Process("HWWAnalysis.C+","Wenu_PTVnuNoJetsBVeto");

  TChain* chain_Wmunu_PTVnuWithB = new TChain("mini");
  chain_Wmunu_PTVnuWithB->AddFile(path+"MC/mc_167743.Wmunu_PTVnuWithB.root");
  chain_Wmunu_PTVnuWithB->Process("HWWAnalysis.C+","Wmunu_PTVnuWithB");
  ...
  chain_Wmunu_PTVnuJetsBVeto->Process("HWWAnalysis.C+","Wmunu_PTVnuJetsBVeto");
  ...
  chain_Wmunu_PTVnuNoJetsBVeto->Process("HWWAnalysis.C+","Wmunu_PTVnuNoJetsBVeto");

  TChain* chain_Wtaunu_PTVnuWithB = new TChain("mini");
  chain_Wtaunu_PTVnuWithB->AddFile(path+"MC/mc_167746.Wtaunu_PTVnuWithB.root");
  chain_Wtaunu_PTVnuWithB->Process("HWWAnalysis.C+","Wtaunu_PTVnuWithB");
  ...
  chain_Wtaunu_PTVnuJetsBVeto->Process("HWWAnalysis.C+","Wtaunu_PTVnuJetsBVeto");
