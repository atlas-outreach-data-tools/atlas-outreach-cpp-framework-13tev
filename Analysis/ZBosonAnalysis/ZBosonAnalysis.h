//////////////////////////////////////////////////////////
#ifndef ZBosonAnalysis_h
#define ZBosonAnalysis_h
...
class ZBosonAnalysis : public TSelector {
  public :
 ...
 TBranch        *b_runNumber;   //!
  ...
  ZBosonAnalysis(TTree * =0) : fChain(0) { }
  virtual ~ZBosonAnalysis() { }
  ...
  ClassDef(ZBosonAnalysis,0);
};

#endif

#ifdef ZBosonAnalysis_cxx
void ZBosonAnalysis::Init(TTree *tree)
{
...
#endif // #ifdef ZBosonAnalysis_cxx
