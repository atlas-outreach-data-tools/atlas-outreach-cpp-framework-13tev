...
void TTbarAnalysis::define_histograms()
{
  ...
  hist_leadjet_m        = new TH1F("hist_leadjet_m",       "Leading Jet Mass; m^{jet} [MeV]; Jets", 20, 0, 20);
  hist_leadjet_jvf      = new TH1F("hist_leadjet_jvf",     "Leading Jet Vertex Fraction; JVF ; Jets", 20, 0, 1);
  hist_leadjet_eta      = new TH1F("hist_leadjet_eta",     "Leading Jet Pseudorapidity; #eta^{jet}; Jets", 30, -3, 3);
  hist_leadjet_MV1      = new TH1F("hist_leadjet_MV1",     "Leading Jet MV1; MV1 weight ; Jets", 20, 0, 1);
