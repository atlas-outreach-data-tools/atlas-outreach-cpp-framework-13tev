...
if (( $choice == 1 )) ; then
  ...
  mkdir Analysis/HWWAnalysis/Output_HWWAnalysis
  ...
  mkdir Analysis/ZPrimeAnalysis/Output_ZPrimeAnalysis
  ...
  rm Analysis/HWWAnalysis/Output_HWWAnalysis/*
  ...
  rm Analysis/ZPrimeAnalysis/Output_ZPrimeAnalysis/*
