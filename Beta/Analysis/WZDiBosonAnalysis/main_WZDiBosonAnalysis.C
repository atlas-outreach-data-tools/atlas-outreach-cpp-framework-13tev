...
void main_WZDiBosonAnalysis(int proof = 0, int option= 0)
{
  ...
  chain_WWlvlv->Process("WZDiBosonAnalysis.C+","WWlvlv");
  ...
  chain_WWlvqq->Process("WZDiBosonAnalysis.C+","WWlvqq");
  ...
  chain_ZZllll->Process("WZDiBosonAnalysis.C+","ZZllll");
  ...
  chain_ZZvvll->Process("WZDiBosonAnalysis.C+","ZZvvll");
  ...
  chain_ZZqqll->Process("WZDiBosonAnalysis.C+","ZZqqll");
  ...
  chain_WZlvll->Process("WZDiBosonAnalysis.C+","WZlvll");
  ...
  chain_WZlvvv->Process("WZDiBosonAnalysis.C+","WZlvvv");
  ...
  chain_WZqqll->Process("WZDiBosonAnalysis.C+","WZqqll");
  ...
  chain_WZlvqq->Process("WZDiBosonAnalysis.C+","WZlvqq");
  }
