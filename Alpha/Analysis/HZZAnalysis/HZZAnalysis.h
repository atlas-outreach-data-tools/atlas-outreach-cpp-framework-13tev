...
class HZZAnalysis : public TSelector {
  ...
  TH1F *hist_fourlepsys_pt_win   = 0;

  TH1F *hist_fourlepsys_y   = 0;
  TH1F *hist_fourlepsys_y_win   = 0;

  TH1F *mass_four_lep  = 0;
  TH1F *mass_four_lep_ext  = 0;
  TH1F *mass_four_mu_win  = 0;
  TH1F *mass_four_e_win  = 0;
  TH1F *mass_twomu_twoe_win  = 0;
