...
void ZZDiBosonAnalysis::define_histograms()
{
  ...
  hist_mLL1         = new TH1F("hist_mLL1",        "Mass of Dilepton System; m_{Z1} [GeV];Events / Bin", 18, 64, 118);
  hist_mLL2         = new TH1F("hist_mLL2",        "Mass of Dilepton System; m_{Z2} [GeV];Events / Bin", 18, 64, 118);
  ...
  // Lepton histograms
  hist_fourleptpt   = new TH1F("hist_fourleptpt",  " Events / Bin Transverse Momentum;p_{T}^{all lep} [GeV];Events / Bin", 20, 0, 200);
  hist_fourlepteta  = new TH1F("hist_fourlepteta", " Events / Bin Pseudorapidity; #eta^{all lep}; Events / Bin", 10, -3, 3);
  hist_fourleptE    = new TH1F("hist_fourleptE",   " Events / Bin Energy; E^{all lep} [GeV]; Events / Bin", 20, 0, 300);
  hist_fourleptphi  = new TH1F("hist_fourleptphi", " Events / Bin Azimuthal Angle ; #phi^{all lep}; Events / Bin", 16, -3.2, 3.2);
  hist_fourleptch   = new TH1F("hist_fourleptch",  " Events / Bin Charge; Q^{all lep}; Events / Bin", 7, -1.75, 1.75);
  hist_fourleptID   = new TH1F("hist_fourleptID",  " Events / Bin Absolute PDG ID; |PDG ID|^{all lep}; Events / Bin",  15, 5.5, 20.5);
  hist_fourlept_ptc  = new TH1F("hist_fourlept_ptc", " Events / Bin Relative Transverse Momentum Isolation; ptconerel30^{all lep}; Events / Bin", 10, -0.1, 0.2);
  hist_fourleptetc  = new TH1F("hist_fourleptetc", " Lepton Relative Transverse Energy Isolation; etconerel20^{all lep}; Events / Bin", 10, -0.1, 0.2);
  hist_fourlepz0    = new TH1F("hist_fourlepz0",   " Lepton z0 impact parameter; z_{0}^{all lep} [mm]; Events / Bin", 10, -1, 1);
  hist_fourlepd0    = new TH1F("hist_fourlepd0",   " Lepton d0 impact parameter; d_{0}^{all lep} [mm]; Events / Bin", 10, -0.2, 0.2);
