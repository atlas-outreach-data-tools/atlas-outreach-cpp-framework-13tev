...
void HyyAnalysis::define_histograms()
{
  ...
  hist_mYY_bin2   = new TH1F("hist_mYY_bin2","Diphoton invariant mass; m_{#gamma#gamma} [GeV];Events / bin", 55, 105, 160.);
  ...
  hist_mYY_cat_bin2   = new TH1F("hist_mYY_cat_bin2","Diphoton invariant mass unconv. central; m_{#gamma#gamma} [GeV];Events / bin", 55, 105, 160.);
}
////////////////////////////////////////////////////////////////////////////////
void HyyAnalysis::FillOutputList()
{
  GetOutputList()->Add(hist_mYY_bin1);
  GetOutputList()->Add(hist_mYY_bin2);
  GetOutputList()->Add(hist_mYY_cat_bin1);
  GetOutputList()->Add(hist_mYY_cat_bin2);
}
////////////////////////////////////////////////////////////////////////////////
