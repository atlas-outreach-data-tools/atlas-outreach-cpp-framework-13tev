...
void WZDiBosonAnalysis::define_histograms()
{
  ...
  hist_mLL           = new TH1F("hist_mLL",          "Mass of Dilepton System; m_{ll};Events", 20, 76, 106);
  hist_etmiss        = new TH1F("hist_etmiss",       "Missing Transverse Momentum;E_{T,Miss} [GeV];Events", 20, 0,120);
  hist_mtw           = new TH1F("hist_mtw",          "Transverse Mass; M^{W}_{T};Events", 20, 0, 200);
  hist_ptLL          = new TH1F("hist_ptLL",         "Transverse momentum of Dilepton System; p^{ll}_{T};Events", 20, 0, 400);
  ...
  hist_threeleptID   = new TH1F("hist_threeleptID",  " Lepton Absolute PDG ID; |PDG ID|^{lep}; Leptons",  15, 5.5, 20.5);
  hist_threelept_ptc  = new TH1F("hist_threelept_ptc", " Lepton Relative Transverse Momentum Isolation; ptconerel30^{lep}; Leptons", 10, -0.1, 0.2);
  hist_threeleptetc  = new TH1F("hist_threeleptetc", " Lepton Relative Transverse Energy Isolation; etconerel20^{lep}; Leptons", 10, -0.1, 0.2);
  hist_threelepz0    = new TH1F("hist_threelepz0",   " Lepton z0 impact parameter; z_{0}^{lep} [mm]; Leptons", 10, -1, 1);
  hist_threelepd0    = new TH1F("hist_threelepd0",   " Lepton d0 impact parameter; d_{0}^{lep} [mm]; Leptons", 10, -0.2, 0.2);
